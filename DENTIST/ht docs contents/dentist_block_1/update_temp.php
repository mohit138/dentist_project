...
//____________________________________THSI IS THE MAIN LIVE PART OF PROJECT. ____________________________
//____________________________ BELOW GIVEN PHP CODE CHECKS LATEST TEMPERATURES WITH DATABSE____________________
//__________________ AFTER GETTING LATEST TEMP VALUES, THE TEMPERATURES TABLES ARE UPDATED IN EVERY 400 ms_____________


//___________ THE HTML CODE BELOW MAKES A CONTAINER AND ROWS TO ACCOMODATE TEMPERATURE VALUES _______________
...
<body>
	...
	<div class="container">
		<div class="row"> <!-- this row contains 8 boxes ! -->
			<div class="col-sm-6">
				<div class="row">
				...
				<div>
					...
					<div class ="container">
						<div class="row inner_col">
							<div class="col-3" id="c"> <?php if($temp1 == null) echo"-"; else echo $temp1; ?> </div>
							<div class="col-3" id="c"><?php if($temp2 == null) echo"-"; else echo $temp2; ?></div>
							<div class="col-3" id="c"><?php if($temp3 == null) echo"-"; else echo $temp3; ?></div>
							<div class="col-3" id="c"><?php if($temp4 == null) echo"-"; else echo $temp4; ?></div>
						</div>
					</div>
				</div>
			</div>
